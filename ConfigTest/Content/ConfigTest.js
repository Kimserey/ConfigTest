    ...
    Next:{
     ...
     Attrs:{
      Animated:function(tr,view,set)
      {
       ...
       flags=4;
       Trans.CanAnimateEnter(tr)?flags=flags|1:null;
       Trans.CanAnimateExit(tr)?flags=flags|2:null;
     ...
     ListModel:Runtime.Class({
       ...
       if(!ListModels.Contains(this.get_Key(),item,v))
        {
         ...
         _=Var1.Set(this.Var,objectArg.Add(item,v));
        }
       else
        {
         ...
         _=Var1.Set(m.Var,objectArg1.SetAt(index,item,v));
        }
       return _;
      },
      Clear:function()
       ...
       if(ListModels.Contains(this.key,item,v))
        {
         ...
         _=Var1.Set(this.Var,objectArg.RemoveIf(arg00,v));
        }
       else
        {
         _=null;
      ...
      RemoveBy:function(f)
      {
       ...
       arg10=Var1.Get(this.Var);
       return Var1.Set(v,objectArg.RemoveIf(arg00,arg10));
      },
      RemoveByKey:function(key)
      {
       var v,objectArg,arg00,m=this,arg10;
       v=this.Var;
       objectArg=this.Storage;
       arg00=function(i)
       {
         ...
         if(matchValue1.$==1)
          {
           value=matchValue1.$0;
           objectArg=m.Storage;
           _1=Var1.Set(m.Var,objectArg.SetAt(index,value,v));
          }
         else
          {
           _1=null;
     ...
     Router1:Runtime.Class({},{
      ...
      {
       var arg10;
       arg10=Router1.Merge(sites);
       return Router1.Prefix(prefix,arg10);
      },
     ...
     Snap1:{
      ...
      {
       var matchValue,_,y,res,v,triggered,obs,cont;
       matchValue=[sn1.State,sn2.State];
       if(matchValue[1].$==0)
        {
         y=matchValue[1].$0;
         _=Snap1.CreateForever(y);
        }
       else
        {
         res=Snap1.Create();
         ...
         cont=function()
         {
          var _1,matchValue1,_2,_3,y1,_4,y2,_5,y3;
          if(triggered[0])
           {
            matchValue1=v[0];
            if(matchValue1.$==1)
             {
              matchValue1.$0;
              if(Snap1.IsForever(sn2))
               {
                y1=matchValue1.$0;
                _3=Snap1.MarkForever(res,y1);
               }
              else
               {
                if(matchValue1.$==1)
     ...
     View:Runtime.Class({},{
      ...
      {
       var o1,o2,res,init,initialised,obs;
       o1=_arg7.$0;
       o2=_arg6.$0;
...
(function()
{
 var Global=this,Runtime=this.IntelliFactory.Runtime,Config,List,UI,Next,Doc,ConfigTest,Client;
 Runtime.Define(Global,{
  ConfigTest:{
   Client:{
    Main:Runtime.Field(function()
    {
     var test,arg20;
     test=Config.test;
     arg20=List.ofArray([Doc.TextNode(Config.hello),Doc.TextNode(test)]);
 ...
 Runtime.OnInit(function()
 {
  Config=Runtime.Safe(Global.Config);
  List=Runtime.Safe(Global.WebSharper.List);
  UI=Runtime.Safe(Global.WebSharper.UI);
  Next=Runtime.Safe(UI.Next);
  Doc=Runtime.Safe(Next.Doc);
  ConfigTest=Runtime.Safe(Global.ConfigTest);
  return Client=Runtime.Safe(ConfigTest.Client);
 });
 Runtime.OnLoad(function()
 {
  Client.Main();
